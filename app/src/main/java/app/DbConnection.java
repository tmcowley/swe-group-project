...
public class DbConnection {
    ...
    public DbConnection() throws SQLException {
        try {
            ...
            SQLException updatedException = new SQLException("Error: DB failed to connect; ensure server is running",
                    e);
    ...
    public Host createHost(String f_name, String l_name, String e_address) {
        ...
        try {
            String createHost = "" + "INSERT INTO host(f_name, l_name, e_address, host_code) " + "VALUES(?, ?, ?, ?) "
                    + "RETURNING host_id;";
    ...
    public TemplateComponent createTemplateComponent(TemplateComponent tc) {
        ...
        if (tc.getType().equals("question")) {
            return createQuestionTemplateComponent(tc.getName(), tc.getType(), tc.getPrompt(), tc.getTextResponse(),
                    tc.getTc_considered_in_sentiment(), tc.getTc_sentiment_weight());
        }

        // if component is of type option
        if (tc.getType().equals("radio") || tc.getType().equals("checkbox")) {
            return createOptionTemplateComponent(tc.getName(), tc.getType(), tc.getPrompt(),
                    tc.getTc_sentiment_weight(), tc.getOptions(), tc.getTc_options_pos(), tc.getOptionsAns());
        }
     ...
     * @param optionsAns   Array of boolean responses to options array e.g. t, f, t
     *                     for checkbox type; empty if type is question
     * @param textResponse Text response field following prompt (null if type radio
     *                     or checkbox)
     * @return Stored template component
     */
    public TemplateComponent createTemplateComponent(String name, String type, String prompt, String[] options,
            Boolean[] optionsAns, String textResponse) {
        PreparedStatement stmt = null;
        ResultSet rs = null;
        Integer tc_id = null;
        try {
     ...
     * @return Stored template component
     */
    public TemplateComponent createOptionTemplateComponent(String name, String type, String prompt, Integer weight,
            String[] options, Integer[] tc_options_pos, Boolean[] optionsAns) {
        PreparedStatement stmt = null;
        ResultSet rs = null;
        Integer tc_id = null;
        try {
     ...
     * @return Stored template component
     */
    public TemplateComponent createQuestionTemplateComponent(String name, String type, String prompt,
            String textResponse, Boolean tc_considered_in_sentiment, Integer tc_sentiment_weight) {
        PreparedStatement stmt = null;
        ResultSet rs = null;
        Integer tc_id = null;

        // debugging statements
        // System.out.println("createQuestionTemplateComponent inputs: name" + name + ",
        // type: " + type + ", prompt: " + prompt + ", text response: " + textResponse);
    ...
    public Boolean updateQuestionTemplateComponent(int tc_id, String prompt) {
        ...
        try {
            // create empty template object
            String updateQuestionTemplateComponent = "" + "UPDATE template_component " + "SET tc_prompt=? "
                    + "WHERE tc_id=?;";
     ...
     * @return Stored template instance
     */
    public Template createTemplate(int host_id, String template_name, Timestamp timestamp,
        ...
        try {
            ...
            String createTemplate = "" + "INSERT INTO template(host_id, template_code, template_name, timestamp) "
    ...
    public Participant createParticipant(String f_name, String l_name) {
        ...
        try {
            createParticipant = "" + "INSERT INTO participant(f_name, l_name) " + "VALUES(?, ?) "
     ...
     */
    public Event createEvent(int host_id, int template_id, String title, String desc, String type, Timestamp start_time,
            Timestamp end_time) {
     ...
     * @return Event instance representing stored data
     */
    public Event createEvent(int host_id, String title, String desc, String type, Timestamp start_time,
            Timestamp end_time) {
        // generate unique event code
        String event_code = generateUniqueEventCode();
    ...
    public Feedback createFeedback(Feedback feedback) {
        ...
        return createFeedback(feedback.getParticipantID(), feedback.getEventID(), feedback.getAnonymous(),
                feedback.getTimestamp(), feedback.getResults(), feedback.getWeights(), feedback.getTypes(),
                feedback.getKeys(), feedback.getSub_Weights(), feedback.getCompound(), keyResultsArray);
    }

    /**
     * Create an instance of feedback against an event
     * 
     * @param participant_id Participant id of the participant who created this
     *                       feedback
     * @param event_id       Event id of the event which this feedback is written
     *                       for
     ...
     * @param weights        Weights array (for weighted mean) associated with each
     *                       result
     * @param types          Type array of query that produced each result
     * @param keys           Keys array that holds whether a result is a key result
     *                       or not
     * @param sub_weights    Sub_weights array that holds weights (unprocessed then
     *                       processed) associated with each set result in multiple
     *                       choice queries
     * @param compound       Compound score of sentiment
     * @param key_results    an array of all key results
     * @return Feedback instance representing stored data
     */
    public Feedback createFeedback(int participant_id, int event_id, boolean anonymous, Timestamp time_stamp,
            String[] results, Float[] weights, byte[] types, Boolean[] keys, byte[][] sub_weights, Float compound,
            String[] key_results) {
    ...
    public Boolean addParticipantToEvent(int participant_id, int event_id) {
        ...
        ResultSet rs = null;
        try {
            String addParticipantToEvent = "" + "INSERT INTO participant_in_event(participant_id, event_id) "
                    + "VALUES(?, ?) ";
    ...
    public Boolean participantInEvent(int participant_id, int event_id) {
        ...
        Boolean state = null;
        try {
            String queryParticipantInEvent = "" + "SELECT EXISTS " + "(SELECT 1 FROM participant_in_event WHERE "
                    + "participant_in_event.participant_id=? " + "AND " + "participant_in_event.event_id=? " + ");";
    ...
    public Boolean participantInEventIsMuted(int participant_id, int event_id) {
        ...
        Boolean muted = null;
        try {
            String queryMutedState = "" + "SELECT muted FROM participant_in_event WHERE "
                    + "participant_in_event.participant_id=? " + "AND " + "participant_in_event.event_id=?;";
    ...
    public Boolean muteParticipantInEvent(int participant_id, int event_id) {
        ...
        ResultSet rs = null;
        try {
            String muteParticipant = "" + "UPDATE participant_in_event " + "SET muted = ?" + "WHERE "
                    + "participant_in_event.participant_id=? " + "AND " + "participant_in_event.event_id=?;";
    ...
    public boolean componentInTemplate(int component_id, int template_id) {
        ...
        Boolean state = null;
        try {
            String queryComponentInTemplate = "" + "SELECT EXISTS " + "(SELECT 1 FROM component_in_template WHERE "
                    + "component_in_template.component_id=? " + "AND " + "component_in_template.template_id=? " + ");";
    ...
    public Boolean addComponentToTemplate(int component_id, int template_id) {
        ...
        ResultSet rs = null;
        try {
            String addComponentToTemplate = "" + "INSERT INTO component_in_template(component_id, template_id) "
                    + "VALUES(?, ?) ";
    ...
    public Host getHostByCode(String host_code) {
        ...
        if (!validator.hostCodeIsValid(host_code))
            return null;
        if (!hostCodeExists(host_code))
            return null;
    ...
    public Template getTemplateByCode(String template_code) {
        ...
        if (!validator.templateCodeIsValid(template_code))
            return null;
        if (!templateCodeExists(template_code))
            return null;
    ...
    /**
     * Get an array of templates created by a host ordered in descending order of
     * creation
     * 
    ...
    public Template[] getTemplatesByHostID(int host_id) {
        ...
        try {
            ...
            stmt = this.conn.prepareStatement(queryTemplateByCode, ResultSet.TYPE_SCROLL_INSENSITIVE,
            ...
            while (rs.next()) {
                foundTemplate = new Template(rs.getInt("template_id"), rs.getInt("host_id"),
                        rs.getString("template_name"), rs.getString("template_code"), rs.getTimestamp("timestamp"));
    ...
    public Event getEventByCode(String event_code) {
        ...
        if (!validator.eventCodeIsValid(event_code))
            return null;
        if (!eventCodeExists(event_code))
            return null;
    ...
    private TemplateComponent getTemplateComponent(int tc_id) {
        ...
        try {
            String selectComponentByID = "" + "SELECT * FROM template_component "
                    + "WHERE template_component.tc_id = ? " + "LIMIT 1;";
            ...
            if (rs.next()) {
                ...
                tc = new TemplateComponent(id, name, type, prompt, tc_considered_in_sentiment, tc_sentiment_weight,
                        options, options_pos, options_ans, text_response);
            }
        } catch (SQLException e) {
            System.out.println(e.getMessage().toUpperCase());
            e.printStackTrace();
    ...
    private Host getHost(int host_id) {
        ...
        Host host = null;
        try {
            String selectHostByID = "" + "SELECT * FROM host " + "WHERE host.host_id = ? " + "LIMIT 1;";
    ...
    public Template getTemplate(int template_id) {
        ...
        try {
            String selectTemplateByID = "" + "SELECT * FROM template " + "WHERE template.template_id = ? " + "LIMIT 1;";

            // works but has extra fields
            String selectComponentsByID = "" + "SELECT * FROM template_component c "
                    + "INNER JOIN component_in_template ct " + "ON (c.tc_id = ct.component_id) "
            ...
            while (rs2.next()) {
                ...
                templateComponent = new TemplateComponent(id, name, type, prompt, tc_considered_in_sentiment,
                        tc_sentiment_weight, options, options_pos, options_ans, text_response);
    ...
    public Participant getParticipant(int participant_id) {
        ...
        try {
            String getParticipantByID = "" + "SELECT * FROM participant " + "WHERE participant.participant_id = ? "
                    + "LIMIT 1;";
    ...
    private Event getEvent(int event_id) {
        ...
        Event event = null;
        try {
            String selectEventByID = "" + "SELECT * FROM event " + "WHERE event.event_id = ? " + "LIMIT 1;";
            ...
            if (rs.next()) {
                ...
                event = new Event(event_id, host_id, template_id, title, description, type, start_time, end_time,
                        event_code);
            }
        } catch (SQLException e) {
            System.out.println(e.getMessage().toUpperCase());
    ...
    public Feedback getFeedback(int feedback_id) {
        ...
        try {
            ...
            if (rs.next()) {
                ...
                ArrayList<String> keyResults = new ArrayList<String>(Arrays.asList(key_results));

                feedback = new Feedback(rs.getInt("feedback_id"), rs.getInt("participant_id"), rs.getInt("event_id"),
                        (String[]) rs.getArray("results").getArray(), (Float[]) rs.getArray("weights").getArray(),
                        rs.getBytes("types"), (Boolean[]) rs.getArray("keys").getArray(), new byte[0][0],
                        rs.getBoolean("anonymous"), rs.getTimestamp("time_stamp"),
                        Float.valueOf(rs.getFloat("compound")), keyResults);
            }
        } catch (SQLException e) {
            System.out.println(e.getMessage().toUpperCase());
            e.printStackTrace();
    ...
    public Feedback[] getFeedbacksByEventID(int event_id) {
        ...
        try {
            ...
            stmt = this.conn.prepareStatement(queryFeedbackByEventID, ResultSet.TYPE_SCROLL_INSENSITIVE,
                    ResultSet.CONCUR_READ_ONLY);
            stmt.setInt(1, event_id);
            rs = stmt.executeQuery();
            rs.last();
            ...
            while (rs.next()) {
                String[] key_results = (String[]) rs.getArray("key_results").getArray();
                ArrayList<String> keyResults = new ArrayList<String>(Arrays.asList(key_results));
                foundFeedback = new Feedback(rs.getInt("feedback_id"), rs.getInt("participant_id"),
                        rs.getInt("event_id"), (String[]) rs.getArray("results").getArray(),
                        (Float[]) rs.getArray("weights").getArray(), rs.getBytes("types"),
                        (Boolean[]) rs.getArray("keys").getArray(), new byte[0][0], rs.getBoolean("anonymous"),
                        rs.getTimestamp("time_stamp"), Float.valueOf(rs.getFloat("compound")), keyResults);
     ...
     * @param event_id       Event ID
     * @param participant_id Participant ID
     * @return An array of found feedback instances by a specific participant in
     *         this event in descending order of time generated (newest first)
     */
    //
    ...
    /**
     * Check if the given event code exists, and is against an active event
     * 
    ...
    public Boolean eventCodeExists(String event_code) {
        ...
        try {
            String queryEventCodeExists = "" + "SELECT EXISTS(SELECT 1 FROM event WHERE event_code=?);";
    ...
    public Boolean templateCodeExists(String template_code) {
        ...
        Boolean codeExists = null;
        try {
            String queryTemplateCodeExists = "" + "SELECT EXISTS(SELECT 1 FROM template WHERE template_code=?);";
    ...
    public Boolean hostCodeExists(String host_code) {
        ...
        try {
            String queryHostCodeExists = "" + "SELECT EXISTS(SELECT 1 FROM host WHERE host_code=?);";
    ...
    /**
     * Generate a unique event code (4-digit, case insensitive alpha-numeric String)
     * 
    ...
    /**
     * Generate a unique template code (6-digit, case insensitive alpha-numeric
     * String)
     * 
    ...
    /**
     * Generate a unique host code (four-word subset of word list)
     * 
    ...
    public Boolean emailExists(String e_address) {
        ...
        try {
            String queryHostEmailExists = "" + "SELECT EXISTS(SELECT * FROM host WHERE e_address=?);";
    ...
    protected Boolean banHost(int host_id) {
        ...
        try {
            String banHost = "" + "UPDATE host " + "SET sys_ban = ? " + "WHERE host_id = ?;";
    ...
    protected Boolean banHost(String eAddress) {
        ...
        Integer bannedHost = null;
        try {
            String banHost = "" + "UPDATE host " + "SET sys_ban = ? " + "WHERE e_address = ?;";
            stmt = this.conn.prepareStatement(banHost);
            stmt.setBoolean(1, true);
    ...
    protected Boolean banParticipant(int participant_id) {
        ...
        try {
            String banParticipant = "" + "UPDATE participant " + "SET sys_ban = ? " + "WHERE participant_id = ?;";
    ...
    protected Boolean deleteHost(int host_id) {
        ...
        try {
            String deleteHost = "" + "DELETE FROM host " + "WHERE host_id = ?;";
    ...
    public Boolean deleteTemplate(int template_id) {
        ...
        try {
            ...
            String deleteTemplate = "" + "DELETE FROM template " + "WHERE template_id = ?;";
    ...
    public Boolean deleteTemplateComponent(int tc_id) {
        ...
        try {
            String deleteTemplateComponent = "" + "DELETE FROM template_component " + "WHERE tc_id = ?;";
        ...
        if (templateComponentDeleted == null)
            return null;
    ...
    protected Boolean deleteParticipant(int participant_id) {
        ...
        try {
            String deleteParticipant = "" + "DELETE FROM participant " + "WHERE participant_id = ?;";
    ...
    protected Boolean deleteFeedback(int feedback_id) {
        ...
        try {
            String deleteFeedback = "" + "DELETE FROM feedback " + "WHERE feedback_id = ?;";
    ...
    protected Boolean removeParticipantFromEvent(int participant_id, int event_id) {
        ...
        try {
            String participantInEventDeleted = "" + "DELETE FROM participant_in_event "
     ...
     * @return Event instance representing stored data
     */
    // public ArchivedEvent createArchivedEvent(int host_id, String total_mood,
    // String title, String desc, String type, Timestamp start_time, Timestamp
    // end_time){
    // PreparedStatement stmt = null;
    // ResultSet rs = null;
    // Integer event_id = null;
    ...
    // + "INSERT INTO archived_event(host_id, total_mood, title, description, type,
    // start_time, end_time) "
    // + "VALUES(?, ?, ?, ?, ?, ?, ?) "
    // + "RETURNING event_id";
    ...
    // Timestamp start_time = rs.getTimestamp("start_time");
    // Timestamp end_time = rs.getTimestamp("end_time");
    // archivedEvent = new ArchivedEvent(event_id, host_id, total_mood, title,
    ...
    // ArchivedEvent archivedEvent = createArchivedEvent(event.getHostID(),
    // total_mood, event.getTitle(), event.getDescription(), event.getType(),
