...
public class Sentiment {
    ...
    public void main() {
        ...
        // Currently this takes feedback in the form of an array structure i basically
        // made up on the spot
        // When we decide how feedback is actually handled I can easily (hopefully)
        // change this to use the new format
        // All the TODOs are simple stuff not worth programming until we have feedback
        // and sentiment objects sorted

        // TODO - takes each section of text from feedback and runs through getCompound
        // TODO - stores all these compound scores and scores from fixed result queries
        // in an array list
        // TODO - convert arraylist to array and create (or call?) array of weights from
        // feedback
