...
public class Feedback {
    ...
    private Float[] weights; // Holds the weights (for weighted mean) associated with each result (first
                             // unprocessed weights, then processed weights)
    ...
    private byte[][] sub_weights; // Holds weights (unprocessed then processed) associated with each set result in
     ...
     * @param timestamp
     */
    public Feedback(int participant_id, int event_id, String[] results, Float[] weights, byte[] types, Boolean[] keys,
            byte[][] sub_weights, boolean anonymous, Timestamp timestamp) {
     ...
     * @param key_results
     */
    public Feedback(int feedback_id, int participant_id, int event_id, String[] results, Float[] weights, byte[] types,
            Boolean[] keys, byte[][] sub_weights, boolean anonymous, Timestamp timestamp, Float compound,
            ArrayList<String> key_results) {
    ...
    /**
     * gets the weights (for weighted mean) associated with each result (first
     * unprocessed weights, then processed weights)
     * 
    ...
    /**
     * gets weights (unprocessed then processed) associated with each set result in
     * multiple choice queries
     * 
     * @return weights
     */
